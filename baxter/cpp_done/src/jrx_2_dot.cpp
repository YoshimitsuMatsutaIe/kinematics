...
void baxter::Kinematics::jrx_2_dot(const VectorXd& q, const VectorXd& dq, MatrixXd& out) {
   ...
   out(0,1) = (1.0/2.0)*M_SQRT2*sin(q(0))*sin(q(1))*cos(q(2))*dq(1) + (1.0/2.0)*M_SQRT2*sin(q(0))*sin(q(2))*cos(q(1))*dq(2) - 1.0/2.0*M_SQRT2*sin(q(0))*cos(q(1))*cos(q(2))*dq(0) - 1.0/2.0*M_SQRT2*sin(q(1))*cos(q(0))*cos(q(2))*dq(1) - 1.0/2.0*M_SQRT2*sin(q(2))*cos(q(0))*cos(q(1))*dq(2) - 1.0/2.0*M_SQRT2*cos(q(0))*cos(q(1))*cos(q(2))*dq(0);
   ...
   out(1,1) = -1.0/2.0*M_SQRT2*sin(q(0))*sin(q(1))*cos(q(2))*dq(1) - 1.0/2.0*M_SQRT2*sin(q(0))*sin(q(2))*cos(q(1))*dq(2) - 1.0/2.0*M_SQRT2*sin(q(0))*cos(q(1))*cos(q(2))*dq(0) - 1.0/2.0*M_SQRT2*sin(q(1))*cos(q(0))*cos(q(2))*dq(1) - 1.0/2.0*M_SQRT2*sin(q(2))*cos(q(0))*cos(q(1))*dq(2) + (1.0/2.0)*M_SQRT2*cos(q(0))*cos(q(1))*cos(q(2))*dq(0);
   ...
   out(1,6) = 0;
   out(2,0) = 0;
   out(2,1) = -sin(q(1))*sin(q(2))*dq(2) + cos(q(1))*cos(q(2))*dq(1);
   out(2,2) = -sin(q(1))*sin(q(2))*dq(1) + cos(q(1))*cos(q(2))*dq(2);
   out(2,3) = 0;
   out(2,4) = 0;
   out(2,5) = 0;
   out(2,6) = 0;
